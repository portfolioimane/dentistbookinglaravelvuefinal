  ...
  <div class="admin-dashboard">
      ...
      <ul>
        ...
        <li>
          <router-link 
            ...
            <i class="material-icons sidebar-icon">rate_review</i> <!-- Icon for Manage Reviews -->
            Manage Reviews
          </router-link>
        </li>
    ...
    <main class="content">
         <!-- New View Website Link -->
          ...
          <a 
            href="http://localhost" 
            class="sidebar-link viewwebsite" 
            target="_blank">
            <i class="material-icons sidebar-icon">public</i> <!-- Icon for View Website -->
            View Website
          </a>
